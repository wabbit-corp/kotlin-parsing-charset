...
// managed-integrity-v1: 8wjRutnPPNg
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-parsing-charset", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-parsing-charset")
        description.set("Kotlin Multiplatform character-set algebra for parser and lexer implementations.")
        url.set("https://github.com/wabbit-corp/kotlin-parsing-charset")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-parsing-charset")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-parsing-charset.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-parsing-charset.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-parsing-charset"
...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                implementation("one.wabbit:kotlin-java-escape:1.1.0")
